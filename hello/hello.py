...
def hello():
    ...
    p_messages=publisher(_publisher, 'helloTo', hello_to, headers=headers)
    g_messages=greeter(_greeter, 'helloTo', hello_to, headers=headers)
    return "publisher: {}\ngreeter  : {}\n".format(p_messages,g_messages)

def publisher(url, param, value, headers):
