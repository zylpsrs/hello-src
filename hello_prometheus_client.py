...
flask_http_request_total = prometheus_client.Counter("flask_http_request_total", 
  "flask http request total", ['method', 'endpoint'], registry=REGISTRY)
flask_http_request_duration_seconds = prometheus_client.Histogram("flask_http_request_duration_seconds",
